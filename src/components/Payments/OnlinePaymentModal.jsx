            ...
            <div>
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                  ...
                  <div>
                    <strong style={{ fontSize: '13.5px', color: '#14532d', display: 'block' }}>
                      درگاه پرداخت الکترونیک شاپرک (زیبال)
                    </strong>
                    <small style={{ color: '#166534', fontSize: '11.5px' }}>
                      پرداخت امن از طریق کلیه کارت‌های عضو شبکه بانکی شتاب کشور
                    </small>
                  </div>
                </div>
                <span style={{
              ...
              <div style={{ display: 'flex', gap: '10px' }}>
                ...
                >
                  <Lock size={16} />
                  <span>
                    {loading ? 'در حال برقراری ارتباط با درگاه شاپرک…' : 'تأیید و اتصال به درگاه پرداخت شاپرک'}
                  </span>
                </button>
                <button
                  type="button"
