      ...
      <section className="welcome-content-side">
        ...
        <div className="hero-main-pitch">
          ...
          <div className="hero-action-buttons">
            <Link to="/trial" className="btn-primary-trial" onClick={(e) => { e.preventDefault(); go('trial'); }}>
              <span>۵ روز رایگان شروع کنید</span>
              <ChevronLeft size={18} />
            </Link>

            <Link to="/login" className="btn-secondary-plans" onClick={(e) => { e.preventDefault(); go('login'); }}>
